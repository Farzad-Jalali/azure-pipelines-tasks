...
try {
    ...
    Write-Host ("### Executing tracer - targetType : $input_targetType ")
    Write-Host ("### Executing tracer - filepath : $input_filePath ")
    Write-Host ("### Executing tracer - input_script : $input_script ")
