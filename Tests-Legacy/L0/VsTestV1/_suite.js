...
function setResponseFile(name, vstestCmd, isPass) {
    ...
    if (typeof vstestCmd !== "undefined") {
        ...
        let errCode = isPass ? 0 : 1;
        let stdErr = isPass ? "" : "Error string";
...
function getTestDllString(testDlls) {
    let dllString = "";
