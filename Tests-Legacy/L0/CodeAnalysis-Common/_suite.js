...
function createTempDir() {
    var testTempDir = path.join(__dirname, '_temp');
...
describe('Code Analysis Suite', function () {
    ...
    it('Code Analysis common - createDirectory correctly creates new dir', () => {
        // Arrange
        var testStgDir = path.join(__dirname, '_temp');
        createTempDir();
    ...
    // Copied from: https://github.com/Microsoft/vsts-task-lib/blob/master/node/test/dirtests.ts
    it('Code Analysis common - createDirectory fails with conflicting file path', (done) => {
        this.timeout(1000);
    ...
    // Copied from: https://github.com/Microsoft/vsts-task-lib/blob/master/node/test/dirtests.ts
    it('Code Analysis common - createDirectory fails with conflicting parent file path', (done) => {
        this.timeout(1000);
    ...
    // Copied from: https://github.com/Microsoft/vsts-task-lib/blob/master/node/test/dirtests.ts
    it('Code Analysis common - createDirectory no-ops if mkdirP directory exists', (done) => {
        this.timeout(1000);
